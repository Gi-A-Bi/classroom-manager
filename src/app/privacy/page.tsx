...
export default function PrivacyPage() {
  return (
    <>
      ...
      받은 뒤 처리합니다.</p>
      <p>학생의 개인정보에 대한 열람·정정·삭제·처리정지 요구는 법정대리인이 제8조의 연락처 또는
      담임교사를 통해 요청할 수 있습니다.</p>
      ...
      <h2>제8조 (개인정보 관련 문의 및 권익침해 구제)</h2>
      <p>개인정보 처리에 관한 문의, 불만 처리, 피해 구제는 아래로 연락해 주시기 바랍니다.
      운영자는 지체 없이 답변하고 처리합니다.</p>
      <ul>
      <li>문의: healthydol@gmail.com</li>
      </ul>
