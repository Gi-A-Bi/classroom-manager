...
export default function PrivacyPage() {
  return (
    <>
      ...
      <p>보유·이용 기간: <span className="todo">[확인 필요 — 학년도 종료 후 보유기간과 파기 시점 — 설계 문서에 「학년도 종료 시 내보내기 안내 후 삭제 예고」 방식이 검토 중으로 남아 있습니다]</span></p>
      ...
      <p><span className="todo">[확인 필요 — 만 14세 미만 학생이 이용하는 서비스이므로, 학교를 통한 개인정보 수집·이용 안내와 법정대리인 동의를 어떤 절차로 처리할지 확정해야 합니다. 학교가 개인정보처리자이고 이 서비스가 수탁자 지위인지도 함께 확인이 필요합니다]</span></p>

      <h2>제5조 (개인정보의 파기)</h2>
      <p>교사가 학생 또는 학급을 삭제하면 해당 데이터는 데이터베이스에서 즉시 삭제됩니다
      (학급 삭제 시 소속 학생·기록이 함께 삭제되도록 <code>ON DELETE CASCADE</code>로 구성).</p>
      <p>학년도 종료에 따른 파기 절차: <span className="todo">[확인 필요 — 파기 시점과 방법]</span></p>
      ...
      <p>권리 행사는 제8조의 연락처로 서면·전자우편 등을 통해 요청할 수 있으며,
      운영자는 지체 없이 조치합니다. 학생 본인 또는 법정대리인이 요구하는 경우에도 같습니다.
      다만 학급 운영 주체인 담임교사를 통해 요청하는 것이 가장 빠르게 처리됩니다.</p>

      <h2>제8조 (개인정보 보호책임자)</h2>
      <ul>
      <li>개인정보 보호책임자: <span className="todo">[확인 필요 — 성명·직위]</span></li>
      <li>소속: <span className="todo">[확인 필요 — 학교명 등 소속]</span></li>
      <li>연락처: <span className="todo">[확인 필요 — 문의 이메일 (학교 공식 계정 사용 여부 확인)]</span></li>
      </ul>
      <p>정보주체는 개인정보 처리에 관한 문의·불만·피해 구제를 위 연락처로 요청할 수 있으며,
      운영자는 지체 없이 답변하고 처리합니다.</p>
      ...
      <footer>
        <p>운영자: <span className="todo">[확인 필요 — 운영자 성명]</span> · 문의: <span className="todo">[확인 필요 — 문의 이메일 (학교 공식 계정 사용 여부 확인)]</span></p>
