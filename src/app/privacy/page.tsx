...
export default function PrivacyPage() {
  return (
    <>
      ...
      <p className="highlight">제2조에서 수집하는 개인정보(교사 계정, 학생 정보, 학급 운영 기록)는
      <strong>국내 리전(서울, AWS ap-northeast-2)의 데이터베이스에 저장</strong>되며 국외로 이전되지 않습니다.</p>
      <p>다만 아래와 같이 서비스를 제공하는 과정에서 접속 IP 주소 등이 국외로 전달될 수 있습니다.</p>
      <table>
      <thead><tr><th>이전받는 자</th><th>이전 국가</th><th>이전 항목</th><th>이용 목적 및 보유 기간</th></tr></thead>
      <tbody>
      <tr><td>Vercel Inc.</td><td>미국</td><td>접속 시 IP 주소</td><td>웹 애플리케이션 호스팅 — 위탁 업무 수행 기간</td></tr>
      </tbody>
      </table>
      <p>이전 시기와 방법: 서비스 접속 시점에 정보통신망을 통해 전송합니다.</p>
      <p className="note">데이터베이스 운영사인 Supabase, Inc.는 미국 법인이며, 데이터는 위와 같이 국내 리전에
      저장되지만 서비스 운영·기술지원 과정에서 국외에서 접근이 이루어질 수 있습니다.</p>

      <h2>제12조 (개인정보처리방침의 변경)</h2>
      <p>이 개인정보처리방침은 2026년 9월 14일부터 적용됩니다. 법령·서비스 변경에 따라 내용이 추가·삭제·수정될
